...
const Footer = () => {
  return (
    <>
    <footer className="bg-[#063127] pt-12 pb-4 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="mt-4 flex items-center gap-4">
              ...
              <a
                href="https://www.facebook.com/UAEPermitOfficial"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.instagram.com/uaepermit"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition"
              >
              ...
              <a
                href="https://www.linkedin.com/company/uae-permit/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition"
              >
              ...
              <a 
                href="https://www.trustpilot.com/review/uaepermit.com" 
                target="_blank" 
                rel="noopener noreferrer" 
                aria-label="Trustpilot Reviews" 
                className="inline-flex items-center gap-2 h-9 rounded-full border border-white/10 bg-white/5 px-3 text-xs sm:text-sm text-gray-200 transition hover:bg-white/10 hover:text-[#62E9C9]"
              >
                <span className="grid h-7 w-7 place-items-center rounded-full bg-[#62E9C9] text-[#063127]">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-star h-4 w-4" aria-hidden="true">
    ...
    <div className="text-center bg-[#063127] py-4 border-t border-white/20 px-4">
          <p className="text-[14px] font-normal text-white/80 leading-relaxed">
            Copyrights © 2026 UAEPermit.com All Rights Reserved.
          </p>
        </div>
        </>
  );
